...
public class NSExample1 {
	...
	public static void main(String[] args) {
		...
		//m1=new Method03();//yes,object got created and with the help m1 reference we can access it's members
			//or
		NSExample1 m2=new NSExample1();//yes,object got created and with the help m1 reference we can access it's members
		System.out.println("age: "+m2.age);//age=0
		m2.display();//age=0
		m2.display(25);//age=25		
		System.out.println("age: "+m2.age);//25
		
		NSExample1 m3=new NSExample1();//yes,object got created and with the help m1 reference we can access it's members
